...
@section('content')
<div class="max-w-2xl">
<form method="POST" action="{{ route('consumibles.store') }}" class="space-y-4">
@csrf
<div class="card">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input name="codigo_alternativo" value="{{ old('codigo_alternativo') }}"
                       class="form-input" placeholder="Genérico / alterno" style="text-transform:uppercase">
            </div>
        </div>
