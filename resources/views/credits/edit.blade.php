...
<div class="card">
    <div class="card-body grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div><label class="form-label">Monto pendiente</label><input type="text" value="${{ number_format($credit->pending_amount,2) }}" class="form-input bg-gray-100" readonly disabled><p class="text-xs text-gray-400 mt-1">Calculado automáticamente</p></div>
        <div><label class="form-label">Quincenas pendientes</label><input type="text" value="{{ $credit->pending_biweeks }}" class="form-input bg-gray-100" readonly disabled><p class="text-xs text-gray-400 mt-1">Se descuenta en cada nómina</p></div>
