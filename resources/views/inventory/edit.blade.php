...
<div class="card">
    <div class="card-body grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <input name="section" value="{{ old('section',$inventory->section) }}" class="form-input" placeholder="A1, B2…">
        </div>
        <div>
            <label class="form-label">Calidad</label>
            <input name="quality" value="{{ old('quality',$inventory->quality) }}" class="form-input" placeholder="Original, Genérico…">
        </div>
        <div>
