...
<aside id="sidebar"
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1 text-sm">
        ...
        {{-- COMERCIAL --}}
        @if($rol === 'administrador' || in_array($dept, ['comercial', 'administracion']))
        <div class="pt-3">
        ...
        <div class="pt-3">
            ...
            <a href="{{ route('equipment.index') }}" class="nav-link @activeRoute('equipment.*')">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                Equipos
            </a>
            <a href="{{ route('inventory.index') }}" class="nav-link @activeRoute('inventory.*')">
            ...
            <a href="{{ route('spareparts.index') }}" class="nav-link @activeRoute('spareparts.*')">
        ...
        <div class="pt-3">
            ...
            <a href="{{ route('print-counters.index') }}" class="nav-link @activeRoute('print-counters.*')">
        ...
        {{-- RH --}}
        @if($rol === 'administrador' || $dept === 'rh')
        <div class="pt-3">
            <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Recursos Humanos</p>
            <a href="{{ route('employees.index') }}" class="nav-link @activeRoute('employees.*')">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                Empleados
            </a>
            <a href="{{ route('payrolls.index') }}" class="nav-link @activeRoute('payrolls.*')">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                Nóminas
            </a>
            <a href="{{ route('vacations.index') }}" class="nav-link @activeRoute('vacations.*')">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                Vacaciones
            </a>
            <a href="{{ route('absences.index') }}" class="nav-link @activeRoute('absences.*')">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"/></svg>
                Ausentismo
            </a>
            <a href="{{ route('administrative-records.index') }}" class="nav-link @activeRoute('administrative-records.*')">
        ...
        @if($rol === 'administrador')
        <div class="pt-3">
            <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Sistema</p>
