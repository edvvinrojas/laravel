...
class Rent extends Model
{
    ...
    public function items()         { return $this->belongsToMany(Item::class, 'rent_item')->withPivot(['branch_id', 'area_id', 'rent', 'contador_inicial_bn', 'contador_inicial_color', 'has_print_service', 'bn_included', 'bn_cost_per_excess', 'color_included', 'color_cost_per_excess'])->withTimestamps(); }
